  ...
  return (
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Social Links */}
        <div className="glass-strong p-8 rounded-xl animate-slide-in-up" style={{ animationDelay: '0.4s' }}>
        ...
        {/* Response Time */}
        <div className="text-center mt-12 glass p-6 rounded-xl animate-slide-in-up" style={{ animationDelay: '0.6s' }}>
