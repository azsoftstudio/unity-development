...
const ValueCard = memo<{
  ...
  value,
  index
}) => <div className="group relative glass p-8 rounded-2xl transition-smooth interactive-glow animate-slide-in-up border border-border/50 hover:border-primary/30 overflow-hidden" style={{
...
const About = memo(() => {
  ...
  return <div className="min-h-screen pt-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Founder Section */}
        <section className="relative glass-strong p-10 rounded-2xl mb-12 animate-slide-in-up border border-primary/20 overflow-hidden" style={{
        animationDelay: '0.4s'
      }}>
