  ...
  return (
    <div className="min-h-screen pt-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        {/* Mission */}
        <div className="glass p-8 rounded-xl mb-12 animate-slide-in-up">
        ...
        {/* Founder Section */}
        <div className="glass-strong p-8 rounded-xl mb-12 animate-slide-in-up" style={{ animationDelay: '0.4s' }}>
        ...
        {/* Community */}
        <div className="text-center glass p-8 rounded-xl animate-slide-in-up" style={{ animationDelay: '0.6s' }}>
