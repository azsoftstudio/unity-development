...
const ValueCard = memo<{
  ...
  value,
  index
}) => <div className="glass p-6 rounded-xl transition-smooth interactive-glow animate-slide-in-up" style={{
...
const About = memo(() => {
  ...
  return <div className="min-h-screen pt-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {values.map((value, index) => <ValueCard key={value.title} value={value} index={index} />)}
          </div>
        </section>

        {/* Founder Section */}
        <section className="glass-strong p-8 rounded-xl mb-12 animate-slide-in-up" style={{
        animationDelay: '0.4s'
      }}>
        ...
        {/* Community */}
        <section className="text-center glass p-8 rounded-xl animate-slide-in-up" style={{
        animationDelay: '0.6s'
      }}>
